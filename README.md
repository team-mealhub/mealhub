...
- 상품 삭제
  - soft-delete 원리를 이용하여 데이터를 일시적으로 삭제하며, 필요시 데이터를 다시 불러와서 사용할 수 있습니다. 
-상품 숨김 활성화 및 비활성화 
...
## 🗃️ ERD
<img width="2140" height="1342" alt="del (4)" src="https://github.com/user-attachments/assets/36f172e9-2f1e-480c-a512-31ed47cc5af5" />
